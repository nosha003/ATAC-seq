...
#bowtie /home/springer/nosha003/database/bowtie1db/Zea_mays.AGPv4.dna.genome -X 1000 -1 /scratch.global/nosha003/schmitz/atacseq/clean/${ID}_1.fastq -2 /scratch.global/nosha003/schmitz/atacseq/clean/${ID}_2.fastq -S /scratch.global/nosha003/schmitz/atacseq/align/${ID}_bowtie.sam -t -p 4 -v 0  --best --strata -m 3
...
samtools view -S -b -o /scratch.global/nosha003/schmitz/atacseq/align/${ID}_bowtie2_trimmomatic.bam  /scratch.global/nosha003/schmitz/atacseq/align/${ID}_bowtie2_trimmomatic.sam
